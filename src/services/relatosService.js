...
const relato = async (nome, categoria, descricao, foto = null, video = null) => {
    const [results] = await db.query(
        'INSERT INTO post (nome, categoria, descricao, foto, video) VALUES (?,?,?,?,?)',
        [nome, categoria, descricao, foto, video]
    );
